...
parameters = {'kernel':('linear','rbf'), 'C':[1,10,100,500], 'gamma':[0.005,0.001,0.1,1],'decision_function_shape' : ('ovo','ovr')}
#----------------------------------------------------------- 
# train model  
svc = svm.SVC()
clf = GridSearchCV(svc, parameters,n_jobs=17,cv=3)
clf.fit(tempTraces,tempHW)
